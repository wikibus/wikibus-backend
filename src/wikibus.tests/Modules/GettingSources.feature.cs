...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Getting Sources", null, ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("GETting sources")]
        [NUnit.Framework.TestCaseAttribute("brochure", "/brochure/12345", new string[0])]
        [NUnit.Framework.TestCaseAttribute("book", "/book/123456abc", new string[0])]
        [NUnit.Framework.TestCaseAttribute("magazine", "/magazine/Bus%20Kurier", new string[0])]
...
#line 5
   testRunner.And(string.Format("existing {0} \'{1}\'", type, path), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 6
...
#line 8
   testRunner.And(string.Format("{0} \'{1}\' should have been retrieved", type, path), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
this.ScenarioSetup(scenarioInfo);
#line 16
   testRunner.Given("brochure \'/brochure/12345\' doesn\'t exist", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line 17
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("/book/10/image", "10", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/brochure/15/image", "15", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/book/10/image/small", "10", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/brochure/15/image/small", "15", new string[0])]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("/magazine/Buses/issue/66/image", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/magazine/Buses/issue/66/image/small", new string[0])]
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("/book/10/image/large", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/brochure/15/image/large", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/magazine/Buses/issue/66/image/large", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/book/10/image/small", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/brochure/15/image/small", new string[0])]
        [NUnit.Framework.TestCaseAttribute("/magazine/Buses/issue/66/image/small", new string[0])]
