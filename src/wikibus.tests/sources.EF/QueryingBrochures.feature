...
Scenario: Retrieving brochure row with two languages
   ...
   When getting Brochure <https://wikibus.org/brochure/1> 
   Then Id should be <https://wikibus.org/brochure/1>
...
Scenario: Retrieving brochure which doesn't exist
   Given table Sources.Source with data:
      ...
      | 1  | folder     | tr       | en        | 2     | Türkkar City Angel E.D. |
	 And data is inserted
   When getting Brochure <https://wikibus.org/brochure/2> 
...
Scenario: Retrieving brochure with image
   Given table Sources.Source with data:
	 ...
	 And data is inserted
   When getting Brochure <https://wikibus.org/brochure/2> 
   Then Should have image https://wikibus.org/brochure/2/image
...
Scenario: Retrieving book with image
   Given table Sources.Source with data:
      ...
      | 407 | book       | 3qAAAA== |
	 And data is inserted
   When getting Book <https://wikibus.org/book/407>
   Then Should have image https://wikibus.org/book/407/image
...
Scenario: Getting brochure row with date
   Given table Sources.Source with data:
	 ...
	 And data is inserted
   When getting Brochure <https://wikibus.org/brochure/6>
...
Scenario: Getting complete magazine issue
   Given table Sources.Source with data:
     ...
     And table Sources.Magazine with data:
         ...
         | 1  | Bus Kurier |
	 And data is inserted
    When Getting issue <https://wikibus.org/magazine/Bus%20Kurier/issue/13>
    Then Languages should contain pl
     And Issue should match
      ...
      | Pages    | 16    |
      | Month    | 3     |
    And Magazine is <https://wikibus.org/magazine/Bus%20Kurier>