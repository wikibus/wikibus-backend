...
namespace Wikibus.Sources
{
    ...
    public interface ISourcesRepository
    {
        ...
        SearchableCollection<Book> GetBooks(Uri identifier, BookFilters filters, int page, int pageSize = 10);
        ...
        SearchableCollection<Brochure> GetBrochures(Uri identifier, BrochureFilters filters, int page, int pageSize = 10);
        ...
        SearchableCollection<Magazine> GetMagazines(Uri identifier, MagazineFilters filters, int page, int pageSize = 10);
